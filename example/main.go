...
func main() {
	...
	fmt.Println("1. Multi-line ASCII art with different gradient options:")
	asciiArt := []string{
		"    ██████╗ ██████╗  █████╗ ██████╗ ██╗███████╗███╗   ██╗████████╗",
		"   ██╔════╝ ██╔══██╗██╔══██╗██╔══██╗██║██╔════╝████╗  ██║╚══██╔══╝",
		"   ██║  ███╗██████╔╝███████║██║  ██║██║█████╗  ██╔██╗ ██║   ██║   ",
	...
	fmt.Println("1a. Auto-detect (default behavior):")
	...
	fmt.Println("1b. Per-line gradients (each line gets full gradient):")
	...
	fmt.Println("1c. Visual center alignment (good for ASCII art):")
	...
	fmt.Println("2. Multi-color gradient (rainbow):")
	...
	fmt.Println("3. Gradient Color Position Tests:")

	// Test 1: Basic two-color gradient positions
	fmt.Println("\n3a. Two-color gradient (Red to Blue) - Color at specific positions:")
	...
	fmt.Println("\n3b. Green to Magenta gradient - Color positions:")
	...
	fmt.Println("\n3c. Rainbow gradient - Color positions:")
	...
	fmt.Println("\n3e. Interpolation smoothness test (Orange to Purple):")
	...
	fmt.Println("4. Auto-detected theme gradient:")
	...
	fmt.Println("5. Explicitly dark mode gradient (green to magenta):")
	...
	fmt.Println("6. Explicitly light mode gradient (orange to purple):")
	...
	fmt.Println("7. Using NewWithMode for backward compatibility:")
	fmt.Println(compatGradient.ApplyToText("This uses the legacy NewWithMode function"))
	fmt.Println()

	fmt.Println("8. Manual content bounds (like metadata solution):")
	coloredArt2 := g2.ApplyToLines(asciiArt, gradient.WithContentBounds(0, 50))
